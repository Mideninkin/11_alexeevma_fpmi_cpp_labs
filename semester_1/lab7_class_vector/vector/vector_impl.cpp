...
Vector::Vector(size_t vec_size): size_{vec_size}, capacity_{size_}, arr_{new int [capacity_]}
{
...
Vector::Vector(std::initializer_list<int> list) : size_{list.size()}, capacity_{size_}, arr_{new int [capacity_]}
{
    std::cout << "Initializer list" << std::endl;
    std::copy(list.begin(), list.end(), arr_);
}

Vector::Vector(const Vector& other) : size_{other.size_}, capacity_{other.capacity_}, arr_{new int [capacity_]}
{
    std::cout << "Copy constructor" << std::endl;
    std::copy(other.arr_, other.arr_ + size_, arr_);
}

Vector::Vector(int num, size_t vec_size): size_{vec_size}, capacity_{size_}, arr_{new int [capacity_]}
{
...
Vector& Vector::PushBack(int element)
{
...
Vector& Vector::Reserve(size_t Capacity)
{
...
void Vector::Swap(Vector& second)
{
